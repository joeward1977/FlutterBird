...
class Bird extends GameObject {
  ...
  Bird(FluttersGame game, this.x, this.y, this.width, this.height,
      [this.rotation = 0])
      : super(game) {
    collisionToleranceX = game.birdSize / 5;
    collisionToleranceY = game.birdSize / 6;
  ...
  // Checks if bird has hit outer wall
  // If it has, then changes the direction and image of bird
  void hitWall() {
